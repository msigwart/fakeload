 ...
 *
 * The {@code LoadController} retrieves all load changes via a shared instance of type
...
public final class LoadController implements Runnable {
    ...
    LoadController(List<CpuSimulator> cpuSimulators, MemorySimulator memorySimulator) {
