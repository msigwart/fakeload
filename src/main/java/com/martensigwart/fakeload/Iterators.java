...
//     */
//    static boolean contains(Iterator<?> iterator, @Nullable Object element) {
//        if (element == null) {
//            while (iterator.hasNext()) {
...
//     */
//    @CanIgnoreReturnValue
//    static boolean retainAll(Iterator<?> removeFrom, Collection<?> elementsToRetain) {
...
//    static <T> T getOnlyElement(Iterator<T> iterator) {
...
//    @CanIgnoreReturnValue // TODO(kak): Consider removing this?
//    @Nullable
//    static <T> T getOnlyElement(Iterator<? extends T> iterator, @Nullable T defaultValue) {
...
//     */
//    static int frequency(Iterator<?> iterator, @Nullable Object element) {
//        int count = 0;
...
//
     ...
     */
    static <T> Iterator<T> concat(Iterator<? extends Iterator<? extends T>> inputs) {
...
//     */
//    static <T> UnmodifiableIterator<List<T>> partition(Iterator<T> iterator, int size) {
...
//     * @throws IllegalArgumentException if {@code size} is nonpositive
//     */
//    static <T> UnmodifiableIterator<List<T>> paddedPartition(Iterator<T> iterator, int size) {
...
//     */
//    static <T> boolean any(Iterator<T> iterator, Predicate<? super T> predicate) {
...
//     * @since 11.0
//     */
//    static <T> Optional<T> tryFind(Iterator<T> iterator, Predicate<? super T> predicate) {
//        checkNotNull(iterator);
//        checkNotNull(predicate);
//        while (iterator.hasNext()) {
//            T t = iterator.next();
...
//     */
//    @Nullable
//    static <T> T get(Iterator<? extends T> iterator, int position, @Nullable T defaultValue) {
//        checkNonnegative(position);
...
//     */
//    @Nullable
//    static <T> T getNext(Iterator<? extends T> iterator, @Nullable T defaultValue) {
...
//     * @throws NoSuchElementException if the iterator is empty
//     */
//    static <T> T getLast(Iterator<T> iterator) {
//        while (true) {
//            T current = iterator.next();
//            if (!iterator.hasNext()) {
//                return current;
...
//     */
//    @Nullable
//    static <T> T getLast(Iterator<? extends T> iterator, @Nullable T defaultValue) {
...
//     * @since 2.0
//     */
//    static <T> Iterator<T> consumingIterator(final Iterator<T> iterator) {
//        checkNotNull(iterator);
//        return new UnmodifiableIterator<T>() {
//            @Override
//            boolean hasNext() {
...
//     */
//    static <T> UnmodifiableIterator<T> singletonIterator(@Nullable final T value) {
//        return new UnmodifiableIterator<T>() {
//            boolean done;
//
//            @Override
...
//     * Collections#list}.
//     */
//    static <T> UnmodifiableIterator<T> forEnumeration(final Enumeration<T> enumeration) {
...
//     */
//    static <T> Enumeration<T> asEnumeration(final Iterator<T> iterator) {
//        checkNotNull(iterator);
...
//     */
//    @Deprecated
//    static <T> PeekingIterator<T> peekingIterator(PeekingIterator<T> iterator) {
//        return checkNotNull(iterator);
//    }
//
//    /**
